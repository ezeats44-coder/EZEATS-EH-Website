...
export function identity(id){if(typeof id!=='string'||!/^ezeats-owner:[a-z0-9]+(?:-[a-z0-9]+)*$/.test(id)||id.length>100)throw new WorkspaceError('Use a stable ezeats-owner:recipe-name ID. Existing file-recipe IDs are reserved.');return id;}
const contentFields=['id','title','description','servings','preparationMinutes','cookingMinutes','totalMinutes','ingredients','steps','cuisine','mealTypes','difficulty','dietTags','knownAllergens','estimatedCost','currency','moods','heat','familiarity','budget','author','copyrightConfirmed','copyrightStatement','safetyEvidence','dietEvidence','allergenEvidence','privateNotes','imageRights'];

...
function render(r){
 ...
 if(r.estimatedCost)content.append(el('p',`Estimated cost: ${r.estimatedCost.currency} ${r.estimatedCost.amount} ${r.estimatedCost.basis}. Actual costs vary.`));
 ...
 content.hidden=false;status.textContent=r.source.ownership==='third-party'?'Development provider content. Not part of the EZEATS-owned catalog.':'EZEATS meal idea. Missing recipe details are clearly marked.';
}
